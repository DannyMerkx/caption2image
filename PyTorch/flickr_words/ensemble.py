...
several distinct local minima, while these networks then can have similar test scores
...
parser.add_argument('-dict_loc', type = str, default = './flickr_indices')
...
# add 3 for the padding, and beginning/eos token
...
# list all the trained model parameters in the results folder
